...
class PictureRepository extends ServiceEntityRepository
{
     ...
     * @return array
     */
    public function findGalleryPictures()
    {
        $entityManager = $this->getEntityManager();
        // requette pour recupérer les images de la gallery (gallery = true)
    ...
    {
        //on utilise la methode findGalleryPictures() crée dans ce repository pour recuperer la liste d'images de la galerie
        $pictures = $this->findGalleryPictures();
